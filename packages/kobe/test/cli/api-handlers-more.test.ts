...
import { ApiError, type ApiRuntime, VERBS, VerbArgs, findVerb, invokeVerb } from "../../src/cli/api-cmd.ts"
...
describe("schema drill-ins", () => {
  ...
  // Hardcoded on purpose, in canonical VERBS order (the order the index,
  // `--all` and `--help` use).
