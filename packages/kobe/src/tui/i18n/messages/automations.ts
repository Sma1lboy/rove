...
export const en = {
  ...
  noRuns: "Not run yet.",
  responses: "RESPONSES",
  noResponses: "No run has reported back yet. Agents answer with `routine-respond`.",
  responseAwaiting: "awaiting response",
  responseMissing: "no response",
...
export const zh: typeof en = {
  ...
  noRuns: "尚未执行。",
  responses: "回报",
  noResponses: "还没有执行回报。agent 用 `routine-respond` 回报。",
  responseAwaiting: "等待回报",
  responseMissing: "未回报",
