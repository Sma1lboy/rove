...
var KOBE_I18N = (function () {
  ...
  var en = {
    ...
    'hero.requirements': 'Runs on macOS & Linux (Windows via WSL). Install with npm, bun, npx, or one curl line. Rove brings its own Bun runtime. Needs git and one engine CLI on your PATH.',
