...
id = "aider"                     # VendorId; may not shadow a built-in (claude/codex/copilot/kimi/pi/omp) or shipped engine (gemini/opencode/cursor/grok/droid/amp/cline/kiro/maki/antigravity)
