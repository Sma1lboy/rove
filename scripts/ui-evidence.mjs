...
export function validateUiEvidence(files, body) {
  ...
  if (!before || !after || before === after) {
    errors.push('UI source changed: add distinct ![Before](https://...) and ![After](https://...) screenshots under ## UI evidence. Local paths, comments, and code blocks are not evidence.')
  }
